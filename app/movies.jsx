	...
	return (
		<D style={`z_fit z-[1]`}>
			<D
				...
				<P value={`/shows/Tron - Legacy/logo.png`} />
				<T style={`my-[1rem]`}>
					The son of a programmer goes looking for his father and ends up inside the
					digital world that his father created. There he meets his father's corrupted creation and a
					unique ally born inside this world.
				</T>
				<D style={`ax_right`}>
					<B
						click={() => nav("/watch/180")}
			...
			<video
				...
				src="/shows/Tron - Legacy/snip.mp4"
				playsinline
				autoplay
				muted={mute()}
				loop
