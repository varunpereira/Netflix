...
export var BellIcon = () => (
	<svg viewBox="0 0 100 100" x="0" y="0" xmlns="http://www.w3.org/2000/svg" class='`w-[1.5rem] h-[1.5rem] stroke-[.5rem] stroke-white fill-white' >
		<path
...
export var SearchIcon = () => (
	<svg viewBox="0 0 100 100" x="0" y="0" xmlns="http://www.w3.org/2000/svg">
...
export var mic_icon = ({style = () => ""}) => (
	<svg viewBox="0 0 1920 1920" stroke-width="3" stroke="currentColor" class={style()}>
